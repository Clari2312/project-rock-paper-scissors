const choose = document.querySelectorAll('div.choose button');
...
choose.forEach(button => { button.addEventListener('click', getPlayerChoice) });
...
function playRound (playerSelection, computerSelection) {
  ...
  let playerWinCombo = ['1-0', '0-2', '2-1'];
    ...
    if (Number(playerSelection) === computerSelection.value) {
      ...
      roundResults.textContent = "Same choice!!"
...
const winnerResults ={
  ...
  player: ["You Win the game!!!! Click Try again to restart", 'green'],
